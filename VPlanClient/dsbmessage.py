...
class DsbMessage:
	...
	POSSIBLE_EVENTS = [EVENT_CHANGE, EVENT_CREATE, EVENT_DELETE, EVENT_TRIGGER, EVENT_GET]
	POSSIBLE_ACTIONS = [
		ACTION_NEWS, ACTION_VPLAN, ACTION_ANNOUNCEMENT, ACTION_CONFIG, 
		ACTION_REBOOT, ACTION_SUSPEND, ACTION_RESUME, ACTION_FIREALARM,
		ACTION_INFOSCREEN, ACTION_SCREENSHOT, ACTION_STATE, ACTION_RESET, ACTION_MODE
	]
